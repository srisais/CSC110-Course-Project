...
Module Description
==================
This file is the <graphical_interface> module for the project.
This file contains all fo the code that is used for the graphical interface,
using tkinter.
"""
...
class MainWindow:
    """The Main Window class for the graphical interface"""
    def __init__(self, root: Tk):
        ...
        self.cur_course_listings = []
        self.cur_course_selected = None
        ...
        source_folder_button = ttk.Button(root, text="Enter", command=self.get_course_listings_for_listbox)
    ...
    def get_course_listings_for_listbox(self) -> None:
        """Gets the course listings for the current directory."""
        print(f"'{self.data_source_folder.get()}'")
